...
This program can be used to block certain websites during work time to reduce distraction thus improving productivity.
...
```bash
    $-> git clone https://github.com/sarthak180144/website-blocker
